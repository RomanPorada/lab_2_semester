...
Система бронювання номерів в готелі:
готель має номери з унікальними номерами,
створити систему яка дозволить забронювати номер, відмінити бронювання, перевірити чи номер заброньований, отримати список заброньованих номерів в порядку зростання, при забронюванні перевіряє чи номер заброньований
До номера має бути імя людини хто її забронював
вивід дерева в консоль
додавання, видалення броні через консоль
